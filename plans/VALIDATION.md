...
| | Case Editing Dialog | [edit-case-dialog.tsx](https://github.com/ferdianqbl/tuition-workspace-fe/blob/main/src/components/features/cases/components/edit-case-dialog.tsx) | Allows parent owners to edit case details (title, subject, level, location, budget, status) via a form-based dialog. | `[x] OK` |
...
| | Tutor Directory Search | [tutors-page.tsx](https://github.com/ferdianqbl/tuition-workspace-fe/blob/main/src/components/features/tutors/tutors-page.tsx) | Renders paginated listings of tutors, allowing parents to filter by name, qualification, and experience keywords. | `[x] OK` |
