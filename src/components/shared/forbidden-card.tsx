...
export function ForbiddenCard({ message = "Only users with the appropriate role are authorized to access this page." }: ForbiddenCardProps) {
  return (
    <Card className="border-border/40 bg-card/65 flex flex-col items-center justify-center p-12 text-center rounded-3xl min-h-[300px]">
      <CardContent className="flex flex-col items-center p-0">
        ...
        <h3 className="text-lg font-bold text-white mb-2">Access Denied (403 Forbidden)</h3>
