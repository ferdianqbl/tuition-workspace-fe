...
export async function GetMyTutorProfileService(): Promise<IResponse<ITutorProfile | null>> {
  try {
...
export function useGetMyTutorProfile(config?: TQueryConfig<typeof GetMyTutorProfileService>) {
